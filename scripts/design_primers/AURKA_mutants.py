########################################
# Run this script: python AurKA_mutants.py X###X
...
filename = "../../nucleotide_sequences/AurKA.txt"
...
AURKA_primer_generator = primer_design.PrimerGenerator(wt_sequence, first_res=first_residue)
forward_primer, reverse_primer = AURKA_primer_generator.make_single_mutant(wt_residue, residue_number, mut_residue)
