########################################
# Run this script: python MAPK14_mutants.py X###X
...
filename = "../../nucleotide_sequences/MAPK14.txt"
...
MAPK_primer_generator = primer_design.PrimerGenerator(wt_sequence, first_res=first_residue)
forward_primer, reverse_primer = MAPK_primer_generator.make_single_mutant(wt_residue, residue_number, mut_residue)
